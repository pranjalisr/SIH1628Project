...
const page = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://script.google.com/macros/s/AKfycbxSPOJ6MH6g6YypFj84NrmZH9vnK0faBvmhOfQbs6V9ViiCMNU69KD3PWJu9p9onPW16g/exec?catagory=non-tech&level=all"
        );
 ...
 <div className='mt-5'>
      ...
      <h2 className='mt-3 mb-3 mx-2 text-lg font-bold'>
        Courses for Non-Technical Jobs 
      </h2>
