    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://script.google.com/macros/s/AKfycbxSPOJ6MH6g6YypFj84NrmZH9vnK0faBvmhOfQbs6V9ViiCMNU69KD3PWJu9p9onPW16g/exec?catagory=private&level=all"
        );
